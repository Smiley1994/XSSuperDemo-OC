//
//  HFCategoryIndicatorComponentView.h
//  HFCategoryView
//
...
@interface HFCategoryIndicatorComponentView : UIView <HFCategoryIndicatorProtocol>

/**
 指示器的位置
 
 可设置的枚举类型：
 - 底部：HFCategoryComponentPosition_Bottom
 - 顶部：HFCategoryComponentPosition_Top
 */
@property (nonatomic, assign) HFCategoryComponentPosition componentPosition;

/**
 指示器的宽度
 
 默认值为 HFCategoryViewAutomaticDimension（表示与 cell 的宽度相等）。
...
/**
 ...
 默认值为 HFCategoryViewAutomaticDimension （等于 indicatorHeight/2）。
...
/**
 ...
 默认值为 HFCategoryIndicatorScrollStyleSimple
 目前仅HFCategoryIndicatorLineView、HFCategoryIndicatorDotLineView支持，其他子类暂不支持。
 */
@property (nonatomic, assign) HFCategoryIndicatorScrollStyle scrollStyle;
