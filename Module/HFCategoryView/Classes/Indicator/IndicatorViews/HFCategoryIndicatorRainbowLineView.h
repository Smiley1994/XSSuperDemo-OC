//
//  HFCategoryIndicatorRainbowLineView.h
//  HFCategoryView
//
...
/**
 ...
 !!!: 会无视 HFCategoryIndicatorLineView 的 indicatorColor 属性，以 indicatorColors 为准。
 */
@interface HFCategoryIndicatorRainbowLineView : HFCategoryIndicatorLineView
