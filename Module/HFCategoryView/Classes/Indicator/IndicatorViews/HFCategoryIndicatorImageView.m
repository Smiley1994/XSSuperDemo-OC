//
//  HFCategoryIndicatorImageView.m
//  HFCategoryView
//
...
@implementation HFCategoryIndicatorImageView
...
- (void)hf_selectedCell:(HFCategoryIndicatorParamsModel *)model {
    ...
    if (self.isScrollEnabled) {
        ...
        if (self.indicatorImageViewRollEnabled && (model.selectedType == HFCategoryCellSelectedTypeCode || model.selectedType == HFCategoryCellSelectedTypeClick)) {
