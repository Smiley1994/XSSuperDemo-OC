//
//  HFCategoryIndicatorParamsModel.h
//  HFCategoryView
//
 ...
 */
@interface HFCategoryIndicatorParamsModel : NSObject
...
@property (nonatomic, assign) HFCategoryCellSelectedType selectedType;  //cell 被选中类型
