...
@interface HFCategoryTitleCellModel : HFCategoryIndicatorCellModel
...
@property (nonatomic, assign) HFCategoryTitleLabelAnchorPointStyle titleLabelAnchorPointStyle;
